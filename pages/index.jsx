    ...
    <main>
      <section id="home" className="min-h-screen bg-white flex flex-col items-center justify-center relative">
        ...
        <div className="w-5/6 lg:w-4/6 h-full flex flex-col items-center justify-center relative">
          <div className="absolute w-56" style={{ top: '-100px', left: '0' }}>
            <Image src="/logo.svg" alt="Ross Popovs Logo" width={662} height={412} />
          </div>
          <h1 className="text-gradient font-title text-4xl lg:text-6xl mb-2">rostislavs popovs</h1>
          <p className="text-gradient font-title text-xl lg:text-2xl">For VP Welfare & Community</p>
        </div>
        <Link href="#about">
      ...
      <section className="bg-slate min-h-screen flex flex-col items-center justify-center">
        ...
        <div id="about" className="w-5/6 lg:w-4/6 h-full py-10 my-10 grid grid-cols-12 gap-8">
          <div className="flex flex-col justify-center col-span-12 lg:col-span-8">
          ...
          <div className="flex justify-center items-baseline col-span-12 lg:col-span-4 relative">
            <Image
              width={282}
              height={400}
              src={'/me.png'}
            ...
            <div className="absolute bottom-0 left-0">
              <Image width={190} height={30} src="/me.svg" alt="This is me" aria-hidden />
            </div>
            <div className="absolute bottom-0 right-0">
              <Image width={61} height={122} src="/arrow.svg" alt="Arrow" aria-hidden />
            </div>
          </div>
        </div>
      ...
      <section className="flex flex-col items-center justify-center relative bg-slate">
        ...
        <div className="w-5/6 lg:w-4/6 h-full flex flex-col items-center justify-center relative py-10 my-10">
          <h1 className="font-title text-white text-3xl pb-4">{__data.contact.title}</h1>
        </div>
